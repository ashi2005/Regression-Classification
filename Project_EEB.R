...
plot(Y1,Y2)
hist(Y1,col="blue",breaks=12,main="HISTOGRAM OF Heating loads",labels=T,xlab="(Y1)")
hist(Y2,col="red",breaks=10,main="HISTOGRAM OF Cooling loads",labels=T,xlab="(Y2)")
data("mtcars")
count=table(ds$X1)
barplot(count,main="Bar plot for X1(Relative compactness)",xlab="no. of x1")
...
plot(Y1,y1.hat,xlab="observed heating load",
     ylab="predicted heating load",col='blue')
abline(a=0,b=1)

plot(Y2,y2.hat,xlab="observed cooling load",
     ylab="predicted cooling load",col=c("red"))
abline(a=0,b=1)
...
qqnorm(resi)
qqline(resi)
hist(resi1,col="blue",breaks=10,main="HISTOGRAM OF RESIDUALS",labels=T,xlab="residuals(Y1)")
hist(resi2,col="red",breaks=10,main="HISTOGRAM OF RESIDUALS",labels=T,xlab="residuals(Y2)")
...
View(p)
head(p)# first 6 predicted values of Y1
head(training$Y1) # first 6 real 
...
layout(matrix(c(1,2),1,2))
barplot(count5,main="Bar plot for X5(Height)",xlab="possible values of X5",ylab="no. of buildings.",labels=T)
...
plot(X5,Y1,col="red",xlab="height",ylab="heating load")
plot(X5,Y2,col="BLUE",xlab="height",ylab="COOLING load")
